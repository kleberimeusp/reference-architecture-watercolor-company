...
![C1 Contexto Key](c4-model/img/structurizr-contexto-key.png)

## C1 Contexto Completo

![C1 Contexto](c4-model/img/structurizr-contexto.png)

## C2 Containers Key

![C2 Containers Key](c4-model/img/structurizr-containers-key.png)

## C3 Componentes ICA Card

![C3 Componentes ICA Card Key](c4-model/img/structurizr-componentes_icacard-key.png)
![C3 Componentes ICA Card](c4-model/img/structurizr-componentes_icacard.png)

## C3 Componentes ICA Cred

![C3 Componentes ICA Cred Key](c4-model/img/structurizr-componentes_icacred-key.png)
![C3 Componentes ICA Cred](c4-model/img/structurizr-componentes_icacred.png)

## C3 Componentes ICA Invest

![C3 Componentes ICA Invest Key](c4-model/img/structurizr-componentes_icainvest-key.png)
![C3 Componentes ICA Invest](c4-model/img/structurizr-componentes_icainvest.png)

## C3 Componentes ICA Pay

![C3 Componentes ICA Pay Key](c4-model/img/structurizr-componentes_icapay-key.png)
![C3 Componentes ICA Pay](c4-model/img/structurizr-componentes_icapay.png)
